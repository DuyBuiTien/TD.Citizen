...
{
    public partial class UpdateQuocGiaCommand : IRequest<Result<int>>
    {
    ...
    public class UpdateCommandHandler : IRequestHandler<UpdateQuocGiaCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(UpdateQuocGiaCommand command, CancellationToken cancellationToken)
        {
