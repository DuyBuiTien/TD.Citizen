...
{
    public partial class UpdateSalaryCommand : IRequest<Result<int>>
    {
    ...
    public class UpdateCommandHandler : IRequestHandler<UpdateSalaryCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(UpdateSalaryCommand command, CancellationToken cancellationToken)
        {
