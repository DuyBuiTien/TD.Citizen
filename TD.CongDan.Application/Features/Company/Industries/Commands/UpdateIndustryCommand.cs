...
{
    public partial class UpdateIndustryCommand : IRequest<Result<int>>
    {
    ...
    public class UpdateCommandHandler : IRequestHandler<UpdateIndustryCommand, Result<int>>
    {
        ...
        public UpdateCommandHandler(IIndustryRepository repository, IUnitOfWork unitOfWork, IMapper mapper)
        {
