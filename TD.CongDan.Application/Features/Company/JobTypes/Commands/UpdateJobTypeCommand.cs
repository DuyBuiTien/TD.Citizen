...
{
    public partial class UpdateJobTypeCommand : IRequest<Result<int>>
    {
    ...
    public class UpdateCommandHandler : IRequestHandler<UpdateJobTypeCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(UpdateJobTypeCommand command, CancellationToken cancellationToken)
        {
